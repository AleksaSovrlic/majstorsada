<template>
  <main class="w-full">
    <LandingHero :initialTip="landing.tipQuery" :badgeText="landing.hero.badgeText" titleId="elektricar-hero-title">
      <template #title>
        Električar u vašem kraju <span class="whitespace-nowrap">za 30 min.</span>
      </template>
    </LandingHero>
        ...
        <div class="grid gap-4 lg:grid-cols-2">
          ...
          >
            ...
            <p class="mt-2 text-sm sm:text-base text-slate-600">
              Hitne elektro intervencije, servis TA peći i bojlera – brzo povezivanje sa slobodnim električarem u vašoj okolini.
            </p>
