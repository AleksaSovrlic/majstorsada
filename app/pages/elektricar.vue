<template>
  <main class="w-full">
    <LandingHero :badgeText="landing.hero.badgeText" titleId="elektricar-hero-title">
      <template #title>
    ...
    <LandingHowItWorks>
      ...
      <section aria-labelledby="elektricar-content-title">
        <h2 id="elektricar-content-title" class="sr-only">
          Električarske usluge i hitne intervencije
        </h2>

        <div class="grid gap-4 lg:grid-cols-2">
          <section
            aria-labelledby="elektricar-problems-title"
            class="rounded-3xl bg-white/75 backdrop-blur ring-1 ring-black/5 p-6 sm:p-8"
          >
            <h3 id="elektricar-problems-title" class="text-lg sm:text-xl font-extrabold text-brand-navy">
              Za koje kvarove možete poslati zahtev
            </h3>
            <p class="mt-2 text-sm sm:text-base text-slate-600">
              Opišite problem sa strujom i pošaljite zahtev. Prosleđujemo ga trenutno dostupnim električarima za tu vrstu intervencije.
            </p>
          ...
          <section
            aria-labelledby="elektricar-usp-title"
            class="rounded-3xl bg-white/75 backdrop-blur ring-1 ring-black/5 p-6 sm:p-8"
          >
            <h3 id="elektricar-usp-title" class="text-lg sm:text-xl font-extrabold text-brand-navy">
              Zašto MajstorSada
            </h3>
            <p class="mt-2 text-sm sm:text-base text-slate-600">
              Umesto da zovete više brojeva, pošaljite jedan zahtev i dogovorite detalje direktno sa električarom koji prihvati intervenciju.
            </p>
            <ul class="mt-4 space-y-2 text-sm sm:text-base text-slate-700">
            ...
            >
              <span>Pošalji zahtev za električara</span>
      ...
      <section aria-labelledby="elektricar-faq-title" class="mt-8 sm:mt-10">
        <h2 id="elektricar-faq-title" class="text-lg sm:text-xl font-extrabold text-brand-navy text-center">
          Česta pitanja
        </h2>
...
import { elektricarLanding as landing } from '@/utils/serviceLandings'
        ...
        '@graph': [
          ...
          },
          {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 2, name: 'Električar', item: canonicalUrl }
            ]
          }
        ]
      })
