...
export type ServiceLandingPath = `/${ServiceTipSlug}`
...
export interface ServiceOption {
  ...
  iconPath: string
  /** Canonical landing path used for SPA navigation */
  landingPath: ServiceLandingPath
}
